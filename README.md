...
# 🔥 DSA Journey 2026
### by [ajitdev01](https://leetcode.com/ajitdev01) · [GitHub](https://github.com/ajitdev01) · [LinkedIn](https://linkedin.com/in/ajitdev01)

> *"Consistency beats talent. 99 days and counting."*
...
[![Rank](https://img.shields.io/badge/Rank-%23454%2C373-blue?style=for-the-badge)](https://leetcode.com/ajitdev01)
[![Streak](https://img.shields.io/badge/🔥_Streak-99_Days-orange?style=for-the-badge)]()
[![Solved](https://img.shields.io/badge/✅_Solved-298_Problems-green?style=for-the-badge)]()
...
|:---:|:---:|:---:|:---:|:---:|
| **85** / 935 | **158** / 2036 | **55** / 921 | **298** / 3892 | **#454,373** |

</div>

```
📅 Total Active Days  : 99
🔥 Max Streak         : 99 Days  ← Current Streak!
📨 Total Submissions  : 762  (past 1 year)
🏆 Badges Earned      : 4  (Most Recent: 50 Days Badge 2026)
⚡ Currently Attempting: 1 Problem
```
...
| 💎 **Feb 2026 Badge** | Active in February 2026 |
...
```
🐙  GitHub Username  : ajitdev01 (Ajit Dev)
📦  Public Repos     : 14
⭐  Contributions    : 652 in 2026
🔥  Current Streak   : 99 days (Oct 24, 2024 – Present)
📊  Longest Streak   : 99 days (Dec 28, 2025 – Apr 5)
📝  Total Commits    : 679
```
...
| Topic | Estimated Solved | Difficulty Mix |
|-------|--------|---------------|
...
|---------|-----------|------|
| 🗳️ Majority Element | 🟢 Easy | 2 minutes ago |
| 🤖 Walking Robot Simulation | 🟡 Medium | 12 minutes ago |
| 🔢 Single Number | 🟢 Easy | ~30 min ago |
| 🔍 Binary Search (#704) | 🟢 Easy | Today |
| 🤖 Robot Return to Origin | 🟢 Easy | Today |

---

## 📋 Full Problem Tracker — LeetCode #1–155 + Bonus

> **Legend:** ✅ Solved | 🔄 Attempting | ❌ Not Started
...
| 23 | [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | 🔴 | ❌ | Min-heap / divide and conquer |
...
| 82 | [Remove Duplicates from Sorted List II](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/) | 🟡 | ❌ | Prev pointer skip |
| 83 | [Remove Duplicates from Sorted List](https://leetcode.com/problems/remove-duplicates-from-sorted-list/) | 🟢 | ❌ | Skip same value nodes |
...
| 95 | [Unique Binary Search Trees II](https://leetcode.com/problems/unique-binary-search-trees-ii/) | 🟡 | ❌ | Recursive enumerate |
| 96 | [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/) | 🟡 | ❌ | Catalan number DP |
| 98 | [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree/) | 🟡 | ✅ | Pass min/max bounds |
...
| 103 | [Binary Tree Zigzag Level Order](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/) | 🟡 | ✅ | BFS + flip direction |
| 104 | [Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | 🟢 | ✅ | max(L,R) + 1 |
| 105 | [Construct Tree from Preorder and Inorder](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | 🟡 | ✅ | Root = pre[0], split inorder |
| 106 | [Construct Tree from Inorder and Postorder](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/) | 🟡 | ✅ | Root = post[-1] |
| 107 | [Binary Tree Level Order Traversal II](https://leetcode.com/problems/binary-tree-level-order-traversal-ii/) | 🟡 | ✅ | BFS + reverse result |
| 108 | [Convert Sorted Array to BST](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/) | 🟢 | ✅ | Mid as root recursively |
| 109 | [Convert Sorted List to BST](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree/) | 🟡 | ❌ | Slow-fast pointer for mid |
| 110 | [Balanced Binary Tree](https://leetcode.com/problems/balanced-binary-tree/) | 🟢 | ❌ | Height check DFS |
| 111 | [Minimum Depth of Binary Tree](https://leetcode.com/problems/minimum-depth-of-binary-tree/) | 🟢 | ❌ | BFS finds first leaf |
...
| 124 | [Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/) | 🔴 | ❌ | DFS return max single path |
| 129 | [Sum Root to Leaf Numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers/) | 🟡 | ❌ | DFS accumulate digits |
| 144 | [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/) | 🟢 | ❌ | Root then L then R |
| 145 | [Binary Tree Postorder Traversal](https://leetcode.com/problems/binary-tree-postorder-traversal/) | 🟢 | ❌ | L then R then Root |
...
| # | Problem | Diff | Status | Key Idea |
|---|---------|------|--------|----------|
| 17 | [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | 🟡 | ✅ | DFS each digit's letters |
...
| 30 | [Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/) | 🔴 | ❌ | Sliding window + freq map |
...
<details>
<summary>🔐 Security — OWASP Top 10 Quick Reference</summary>
...
<details>
<summary>☁️ DevOps / DevSecOps Cheatsheet</summary>
...
|------|-----------|----------------|
| **Week 1** | 📦 Arrays + Hashing | 1, 26, 27, 49, 56, 88, 128, 136, 169 |
| **Week 2** | 🪟 Two Pointers + Sliding Window | 3, 11, 15, 76, 121, 125 |
| **Week 3** | 🔍 Binary Search | 33, 34, 35, 69, 74, 153, 704 |
| **Week 4** | 🔗 Linked Lists | 2, 19, 21, 23, 141, 142, 146 |
| **Week 5** | 📚 Stacks + Queues | 20, 71, 84, 85, 150, 155 |
| **Week 6** | 🌳 Trees DFS/BFS | 94, 98, 100–108, 110–113, 124 |
| **Week 7** | 🔙 Backtracking | 17, 22, 39, 46, 51, 77, 78 |
| **Week 8** | 💡 Dynamic Programming | 5, 53, 62, 70, 91, 120, 139 |
| **Week 9** | 🌐 Graphs + Advanced | 127, 130, 133, 42, 84 |
| **Week 10** | 🔴 Hard Problems Review | All Hard problems |
...
|----------|---------|------|
| 🟠 LeetCode | Practice platform | [leetcode.com](https://leetcode.com) |
| 🟢 NeetCode | Roadmap + Videos | [neetcode.io](https://neetcode.io) |
| 🔵 CP-Algorithms | Theory deep dives | [cp-algorithms.com](https://cp-algorithms.com) |
| 🟣 Visualgo | Algorithm animations | [visualgo.net](https://visualgo.net) |
| 🔴 Big-O Sheet | Complexity reference | [bigocheatsheet.com](https://bigocheatsheet.com) |
| ⚫ Striver's SDE Sheet | Top 450 interview Qs | [takeuforward.org](https://takeuforward.org) |

### 🔐 Security & DevSecOps
| Resource | Purpose | Link |
|----------|---------|------|
| 🛡️ OWASP | Web security standards | [owasp.org](https://owasp.org) |
| 🎯 HackTheBox | Cybersecurity labs | [hackthebox.com](https://hackthebox.com) |
| 🧪 TryHackMe | Beginner-friendly CTF | [tryhackme.com](https://tryhackme.com) |
| 📖 PortSwigger Web Academy | Free web security labs | [portswigger.net/web-security](https://portswigger.net/web-security) |
| ☁️ AWS Skill Builder | Cloud learning | [skillbuilder.aws](https://skillbuilder.aws) |
| 🐳 Docker Docs | Container mastery | [docs.docker.com](https://docs.docker.com) |

---

<div align="center">

## 🔥 99-Day Streak · 298 Solved · Rank #454,373

### 🧱 Stack: MERN · LAMP · AWS · Docker · DevSecOps · Cybersecurity
